  ...
  return (
    <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex-1 bg-white flex flex-col">
            ...
            <div className="flex-1 w-full py-[40px] px-[160px] flex items-center justify-center">
            <div className="max-w-[400px] w-full rounded-xl py-[24px] px-[16px] gap-[36px] flex flex-col justify-center">
