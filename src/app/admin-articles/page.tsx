  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen w-screen">
      ...
      <div className="flex-1 bg-white flex flex-col">
        ...
        <div className="flex-1 bg-gray-100 overflow-y-auto p-4 md:p-[24px]">
          {/* Header Box */}
          <div className="w-full h-fit border-slate-200 rounded-xl border-[1px]">
            {/* Total Articles */}
            <header className="w-full border-b-[1px] p-4 md:p-[24px] border-slate-200 bg-gray-50">
            ...
            <header className="w-full p-4 md:p-[24px] border-t-[1px] border-slate-200 bg-gray-50">
              <div className="flex flex-col md:flex-row md:justify-between gap-4 md:items-center">
                ...
                <div className="flex flex-col md:flex-row gap-3 w-full">
                  <select
                    className="border-slate-300 border-[1px] rounded-md px-3 py-2 text-sm w-full md:w-[180px]"
                ...
                <Link href="/create-article">
                  <Button className="bg-blue-600 text-white w-full md:w-fit flex items-center justify-center">
